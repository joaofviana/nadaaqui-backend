-- Increase default limit for nearby_places RPC to show all pools
-- Default limit changed from 50 to 100, max from 100 to 200

begin;

-- Recreate the nearby_places function with higher limits
